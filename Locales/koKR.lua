...
L["Scenario"] = "시나리오"
L["Draws a drop-shadow behind the scenario / delve banner text (the Stage and name lines). This is SEPARATE from the Text Shadow above, which affects only the quest and objective text \226\128\148 the banner is styled on its own."] = "시나리오/구렁 배너 글자(단계 및 이름 줄) 뒤에 그림자를 그립니다. 이는 위의 글자 그림자와 별개이며, 글자 그림자는 퀘스트와 목표 글자에만 적용됩니다 - 배너는 따로 스타일링됩니다."
